<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="求购编号" prop="qiugoubianhao">
					<el-input v-model="ruleForm.qiugoubianhao" placeholder="求购编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.qiugoubianhao" label="求购编号" prop="qiugoubianhao">
					<el-input v-model="ruleForm.qiugoubianhao" placeholder="求购编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="求购价格" prop="qiugoujiage">
					<el-input v-model="ruleForm.qiugoujiage" placeholder="求购价格" clearable  :readonly="ro.qiugoujiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="求购价格" prop="qiugoujiage">
					<el-input v-model="ruleForm.qiugoujiage" placeholder="求购价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="求购时间" prop="qiugoushijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.qiugoushijian" 
						type="date"
						:readonly="ro.qiugoushijian"
						placeholder="求购时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.qiugoushijian" label="求购时间" prop="qiugoushijian">
					<el-input v-model="ruleForm.qiugoushijian" placeholder="求购时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="求购详情" prop="qiugouxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.qiugouxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.qiugouxiangqing" label="求购详情" prop="qiugouxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.qiugouxiangqing"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.qiugoushijian = this.getCurDate()
	},
	methods: {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.qiugouxiangqing = this.ruleForm.qiugouxiangqing.replace(reg,'../../../springboot4aj60/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
